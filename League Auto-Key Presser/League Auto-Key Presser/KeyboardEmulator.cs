...
{
    /// <summary>
    /// Emulates key press events
    /// Warning: All methods require elevated trust and will not work on non-Windows environments
    /// </summary>
    public static class KeyboardEmulator
    {
        ...
        public static void SimulateKeyPress(UInt16 keyCode)
        {
            ...
            down.Data.Keyboard.Vk = 0x2C;
            // Scan Code here, was 0
            down.Data.Keyboard.Scan = (ushort)MapVirtualKey(0x2C, 0);
            ...
            up.Data.Keyboard.Vk = 0x2C;
            // Scan Code here, was 0
            up.Data.Keyboard.Scan = (ushort)MapVirtualKey(0x2C, 0);
            up.Data.Keyboard.Flags = (UInt32)0x0002;
